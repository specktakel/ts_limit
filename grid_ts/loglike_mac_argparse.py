...
parser.add_argument("config", help='give a yaml config file with specification of what to plot.')
...
for file in data_list:
    num = int(file.lstrip(f'{directory}/{prefix}').strip(f'{postfix}'))
    # print(num)
...
#plt.savefig('~/roi_0_color_map.png', dpi=150)