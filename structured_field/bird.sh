...
cp -r /nfs/astrop/n1/kuhlmann/NGC_1275/ts_limit/roi_simulation/roi_files/roi_$1 .
echo "STARTING THE PYTHON SCRIPT with arguments:"
echo $1
python /nfs/astrop/n1/kuhlmann/NGC_1275/ts_limit/structured_field/ts_cluster.py $1
